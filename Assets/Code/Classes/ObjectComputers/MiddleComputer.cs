/**
 * FTSWFOS - MiddleComputer - Concrete Class
 *
 * @since       2018.01.09
 * @version     1.0.0.0
 * @author      MLB
...
public class MiddleComputer : AbstractEnvironmentObjectComputer<IEnvironmentObject>
{
    /*********************/
    /***** CONSTRUCT *****/
    /*********************/
    ...
    protected void _GenerateObject()
    {
        ...
        (_pool as IEnvironmentObjectPool).NeedType = EnvironmentObjectType.Middle;
